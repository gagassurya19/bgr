...
const TRANSITIONS: Transition[] = [
  ...
  { from: "REVISION_BY_SUBSIDIARY", to: "SUBMITTED", allowedRoles: ["REFERRAL_OFFICER", "ADMIN", "SUPER_ADMIN"] },
  ...
  { from: "REVISION_BY_SUBSIDIARY", to: "DRAFT", allowedRoles: ["REFERRAL_OFFICER", "ADMIN", "SUPER_ADMIN"] },
  ...
  { from: "SUBMITTED_TO_SUBSIDIARY", to: "COMPLETED", allowedRoles: ["SUBSIDIARY_PROCESSOR", "ADMIN", "SUPER_ADMIN"] },
  { from: "SUBMITTED_TO_SUBSIDIARY", to: "REJECTED", allowedRoles: ["SUBSIDIARY_PROCESSOR", "ADMIN", "SUPER_ADMIN"] },
  { from: "SUBMITTED_TO_SUBSIDIARY", to: "REVISION_BY_SUBSIDIARY", allowedRoles: ["SUBSIDIARY_PROCESSOR", "ADMIN", "SUPER_ADMIN"] },
  ...
  { from: "IN_PROCESS", to: "REVISION_BY_SUBSIDIARY", allowedRoles: ["SUBSIDIARY_PROCESSOR", "ADMIN", "SUPER_ADMIN"] },
